...
<head>
    ...
    <title>Selamat Datang di Sekolah Dasar Harapan Bangsa</title>
    <link rel="shorcut icon" href="<?php echo base_url().'assets/images/sd.png'?>">
    <!-- Bootstrap CSS -->
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        ...
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>info@HarapanBangsa.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Bantul, Yogyakarta, INA. 11001
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url('');?>" class="navbar-brand nav-brand2"><img class="img img-responsive" width="65px;" src="<?php echo base_url().'assets/images/sd.png'?>"></a>
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               <h2>Welcome</h2>
               <p>Kami Menyambut baik terbitnya Website Sekolah Dasar Harapan Bangsa yang baru , dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. </p>
            ...
            <div class="col-md-3">
                <div class="foot-logo">
                    <a href="<?php echo site_url();?>">
                        <img width="100px" src="<?php echo base_url().'assets/images/sd.png'?>" class="img-fluid" alt="footer_logo">
                    </a>
                    <!--<p>Harapan Bangsa</p>-->
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> Bantul, Yogyakarta, INA. 11001</p>
                        <p>Email : info@HarapanBangsa.com
